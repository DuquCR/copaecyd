  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="card mx-auto w-full max-w-md text-center">
        {/* LOGO: Reemplaza con tu logo */}
        <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-primary-500 text-xl font-black text-white">
          EC
        </div>

        <h1 className="mb-2 text-2xl font-bold text-gray-900">Panel de Administración</h1>
        <p className="mb-6 text-sm text-gray-500">
          Inicia sesión con tu cuenta de Google autorizada para acceder al panel.
        </p>
